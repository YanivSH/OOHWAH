...
- (void)viewDidLoad
{
	...
	[self.imageView setImage:[UIImage imageNamed:[NSString stringWithFormat:@"Sketc-Heroes-Logo-1"]]];//,[self movieIndex]]]];
    
    [self.indexButton setTitle:[NSString stringWithFormat:@"%d",self.movieIndex] forState:UIControlStateNormal];
    /*
